      ...
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              >
                ...
                <ul className="space-y-4 mb-8">
                  {[
                    "Projetamos e Executamos Condomínios Residências",
                    "Especialistas em Galpões e Mercados",
                    "Instalações Elétricas e Hidráulicas Industriais",
                    "Revestimentos de Maquinário e Ferros Industriais"
                  ].map((item, i) => (
        ...
        <section className="py-24 bg-brand-gold text-brand-concrete">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-brand-concrete/80 max-w-2xl mx-auto mb-10 text-lg font-medium">
              Elimine goteiras, infiltrações e problemas estruturais. 
              Tratamos sua obra com a seriedade que ela exige.
            </p>
            <a 
